...
import TopLoser from "./TopLosers";
...
export default function SideBar() {
  ...
  const [selectedSection, setSelectedSection] = useState("TopGainers");

  // Sidebar items and their respective components
  const sidebarItems = [
    { name: "TopGainers", component: <TopGainer /> },
    { name: "TopLosers", component: <TopLoser /> },
  ...
  return (
    ...
    // <div className="flex">
    //   <Card className="w-64 h-screen shadow-lg bg-white fixed overflow-hidden overscroll-auto">
    //     {/* Sidebar Navigation */}
    //     <nav className="mt-6 h-full overflow-y-auto">
    //       <List>
    //         {sidebarItems.map((item) => (
